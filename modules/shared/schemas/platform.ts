...
export const prizeBoardSettingsSchema = z.object({
  ...
  cleanCardWidth: z.number().int().min(0).max(1200).default(0),
  cleanCardHeight: z.number().int().min(0).max(900).default(0),
  ...
  cardPadding: z.number().int().min(0).max(120).default(12),
  numberPrefix: z.string().trim().max(24).default(""),
  numberRangeStart: z.number().int().min(0).max(999999999).default(1),
  numberRangeEnd: z.number().int().min(0).max(999999999).default(999),
  numberPadLength: z.number().int().min(0).max(12).default(3),
  fontFamily: z.string().trim().max(120).default("inherit"),
