...
export default async function LuckyDrawAllDisplayPage({ params }: { params: Promise<{ eventOrScreen: string }> }) {
  ...
  return <LuckyDrawDisplay eventOrScreen={eventOrScreen} initialState={state} pollingIntervalMs={settings.fallbackPollingIntervalMs} viewMode="prize" />;
}
